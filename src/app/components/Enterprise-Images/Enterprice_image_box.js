...
const Enterprice_image_box = ({Main_title,Main_des , itemsData }) => {
  return (
    <>
                ...
                >
                  <div className="left md:w-1/2 w-full space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p
                        dangerouslySetInnerHTML={{
                          __html: item.description.replace(/<\/?p[^>]*>/g, ""),
                        }}
                      ></p>
                    </div>
                  </div>
...
export default Enterprice_image_box