...
import { getEDTDate } from "@/app/utilites/ConvertDate";
...
import { UploadCsvFile } from "@/app/api/UploadCsvFile";
import { FetchHaloRiskContribution } from "@/app/api/FetchHaloRiskContribution";
import { AddMiscellaneousLogs } from '@/app/api/AddMiscellaneousLogs';
...
const EditablePortfolioTable = dynamic(() => import('@/app/components/PortfolioDetailsTable/EditablePortfolioTable'), { ssr: false });
    ...
    const MyDocument = ({ chartDataURL }) => (
        <Document>
            <Page size="A4" style={styles.body}>
                <PDFImage src="/app/Assets/Halo/Halo-logo.png" style={{ width: 80, height: 30 }} />
                            ...
                            <div className="riskstate halorisk">
                                ...
                                <div className="riskstate">
                                    ...
                                    <div className="lblrisk">Index Volatility
                                        <>
                                            &nbsp;<img src="/app/Assets/risk-info.png" title= {`Historical ${selectedIndex} Volatility`}></img>
                                        </>
                                    </div>
                                </div>
                            </div>
