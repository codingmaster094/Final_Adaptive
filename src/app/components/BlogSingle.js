...
const BlogSingle = ({ SinglePost }) => {
  ...
  useEffect(() => {
    ...
    const handleToggle = () => {
      ...
      if (tocCollapse.classList.contains("expanded")) {
        ...
        tocCollapse.style.maxHeight = "220px";
      }
    };
  ...
  return (
    <div className="container">
      <div className="top xl:pt-[200px] lg:pt-[180px] md:pt-[160px] pt-[140px]  xl:pb-[100px] lg:pb-20 md:pb-14 sm:pb-10 pb-6 lg:space-y-16 md:space-y-8 space-y-6">
        <div className="main-text sm:space-y-8 space-y-6">
          <h1 className="text-h1 font-semibold font-ivy">
            Stay Updated with Adaptive
          </h1>
          <div className="para font-inter text-black font-normal text-h5">
            <p>
        ...
        <div className="mid-block flex xl:gap-16 md:gap-8 gap-6 justify-start lg:flex-row flex-col">
          <div className="left lg:w-[40%] md:w-[60%] w-full">
            <Image
              src={SinglePost[0].featured_image_data.url}
              alt={SinglePost[0].title.rendered}
              width={600}
              height={400}
              className="w-full md:h-[240px] object-cover object-center"
              role="img"
            />
          </div>
          <div className="right lg:w-[60%] w-full font-inter flex flex-col justify-between sm:gap-16 gap-6">
            <div className="head space-y-5">
              ...
              <div className="main space-y-4">
                <h2 className="text-h3 font-semibold w-[90%]">
                  {SinglePost[0].title.rendered}
                </h2>
                <div
                  className="para"
                  dangerouslySetInnerHTML={{
                    __html: SinglePost[0].excerpt.rendered,
                  }}
                ></div>
              </div>
            </div>

            <div className="view w-full flex justify-between items-center">
              <div className="left flex gap-3 justify-start items-center">
                <img src="/img/author.jpg" alt="author image" role="img" />
                <span className="font-semibold">
                  By {SinglePost[0].author_name}
                </span>
              </div>
              {/* <div className="right flex gap-3 justify-start items-center">
        ...
        <div className="scroll-section px-4 py-8 flex lg:gap-16 gap-8 lg:flex-row flex-col">
          <aside
            ...
            <div className="sticky pb-6 top-[20%]">
              <div className="bg-white overflow-hidden pt-6 relative border-2 rounded-xl border-black-100">
                ...
                <div className="main-bar relative">
                  <div
                    className="overflow-hidden transition-all duration-500 max-h-[220px]"
                    id="toc-collapse"
                    ref={tocCollapseRef}
                  >
                    <div className="relative" style={{ transform: "none" }}>
                      ...
                      <div
                        ...
                        id="toc-progress"
                      ></div>
                      <div className="list px-6 flex flex-col gap-5">
                        <div className="">
                          <a
                            href="#section1"
                            data-target="section1"
                            className="toc-link inline-block lg:ml-8 text-h5 font-medium text-black opacity-40 leading-6 px-2 relative transition-colors duration-200 pl-2 mb-3"
                          >
                            Stock market & investment
                          </a>
                          <div className="pl-12 font-inter text-black text-body flex flex-col gap-2">
                            <p>Common stock</p>
                            <p>Common stock</p>
                            <p>Common stock</p>
                          </div>
