                            ...
                            <div className="item card-item h-full flex flex-col relative py-8 border-b-[1.5px] border-b-solid border-b-black-200">
                                ...
                                {main_item &&
                                    main_item.acf.mike_videos.map((sub_item, index) => (
                                        <div className="bg-white py-6 flex flex-col flex-1" key={index}>
                                            <h3 className="text-h5 font-medium font-inter md:min-h-[20px] min-h-auto mb-8" dangerouslySetInnerHTML={{ __html: sub_item.title }}>
                                            </h3>
                                            <Image
