          ...
          <div class="inner lg:space-y-[100px] md:space-y-16 space-y-6">
            <div class="top text-black text-left space-y-6">
              ...
              <div class="text text-body font-inter font-normal text-black-100">
                <p>
                  ...
                  offers effortless downside protection tailored to your unique
                  diversified portfolio. With Market Shield, you can safeguard
                  your investments without the complexity often associated with
                  risk management. Our tool is designed for ease of use, giving
                  both advisors and clients the peace of mind they need in
                  volatile conditions.
                </p>
              </div>
            </div>
            <div class="top text-black text-left space-y-6">
              ...
              <div class="text text-body font-inter font-normal text-black-100 space-y-4">
                ...
                <p>
                  Market Shield offers a cost-effective alternative without
                  compromising efficacy. Unlock cost-effective coverage that
                  aligns perfectly with your financial goals and allows your
                  portfolio to breathe—because when markets fluctuate, your
                  clients peace of mind shouldn't have to.
                </p>
              </div>
            </div>
          </div>
